...
export const devicesFixture: DeviceList = {
  ...
  items: [
    ...
    device(18, 'Tree-pit multi-depth probe', 'multi_depth_soil_probe', 'unknown', treeFeature),
    {
      ...
      unit_confirmation_summary: 'confirmed',
      environment: 'test',
      source_system: 'ttn',
...
const replayMeasurement: MeasurementValue = {
  ...
  channel_name: 'Outflow A (Total)',
  metric_code: 'outflow_total',
  metric_name: 'Outflow A (Total)',
  numeric_value: 840,
  unit_code: 'ml',
  unit_symbol: 'mL',
  unit_confirmation_status: 'confirmed',
  verification_status: 'catalogued',
...
const replayMeasurementTwo: MeasurementValue = {
  ...
  channel_name: 'Outflow A',
  metric_code: 'outflow_rate',
  metric_name: 'Outflow A',
  numeric_value: 200,
  unit_code: 'ml_h',
  unit_symbol: 'mL/hour',
};
  ...
  channels: [
    {
      ...
      water_level_reference_or_datum: null,
      scientific_meaning:
        'Measurement ID 1 is mapped to Outflow A (Total) from supplied sensor metadata.',
      verification_status: 'catalogued',
      timestamp_basis: 'ttn_received_at',
      active: true,
    },
    {
      ...
      reporting_jitter_tolerance_seconds: null,
      water_level_reference_or_datum: null,
      scientific_meaning: 'Measurement ID 2 is mapped to Outflow A from supplied sensor metadata.',
      verification_status: 'catalogued',
      timestamp_basis: 'ttn_received_at',
      active: true,
    },
